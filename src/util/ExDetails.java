...
public class ExDetails {
	...
	public static ExDetails firstStudent() {
		return new ExDetails("315683854", "Saar", "Keshet",
				"saar.keshet@e.braude.ac.il");
	}

	// Put the second student details here
	public static ExDetails secondStudent() {
		return new ExDetails("312893829", "Vladislav", "Yefremov", "vladislav.yefremov@e.braude.ac.il");
